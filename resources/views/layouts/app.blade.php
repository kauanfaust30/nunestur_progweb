...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .btn-danger-outline:hover { background: #fcebeb; }
        ...
        .note-success { color: #2a9d5c !important; }
        ...
        .alert-success-custom { background: #eaf3de; color: #3b6d11; border-left: 3px solid #639922; }
        .alert-danger-custom  { background: #fcebeb; color: #a32d2d; border-left: 3px solid #e24b4a; }
        .alert-info-custom    { background: #e6f1fb; color: #185fa5; border-left: 3px solid #378add; }
